...
class Metaclass_SwitchMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_interfaces.srv.SwitchMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_interfaces.srv import _switch_mode
...
class SwitchMode(metaclass=Metaclass_SwitchMode):
    from turtle_interfaces.srv._switch_mode import SwitchMode_Request as Request
    from turtle_interfaces.srv._switch_mode import SwitchMode_Response as Response
